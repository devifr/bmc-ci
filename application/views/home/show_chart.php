...
<head>
	...
	<title>Show Chart Jumlah Mahasiswa dan Dosen</title>
	...
	<script language="javascript" type="text/javascript" src="<?php echo base_url('asset/js/jquery.flot.js'); ?>"></script>
	<script language="javascript" type="text/javascript" src="<?php echo base_url('asset/js/jquery.flot.pie.js'); ?>"></script>
	...
	$(function() {
		...
		var data = [],
			jml_data = ["<?php echo $jml_mahasiswa; ?>","<?php echo $jml_dosen; ?>"],
			series = 2;
			nama_label = ['Mahasiswa','Dosen']
		...
		$("#example-1").click(function() {
			...
			$("#title").text("Jumlah Mahasiswa Dan Dosen");
			$("#description").text("Menampilkan Jumlah Mahasiswa dan Dosen");
